            ...
            styleOverrides: {
                root: {
                    backgroundColor: alpha(
                        theme.palette.grey[
                            theme.palette.mode === "light" ? 900 : 600
                        ],
                        0.2,
                    ),
                },
...
export interface ThemeSliceType {
    ...
    setTheme_LightOrDarkMode: Dispatch<
    ...
    setTheme_SecondaryColor: Dispatch<
        SetStateAction<TypeThemeColors>
    >;
    Theme_SelectedShadeType_Primary:
        "lightShade" | "mainShade" | "darkShade";
...
const useThemeSlice = () => {
    ...
    const [Theme_LightOrDarkMode, setTheme_LightOrDarkMode] =
    ...
    ] = useState<"lightShade" | "mainShade" | "darkShade">(
        "mainShade",
    );
    ...
    [
        ShadeCode_Secondary_0,
        ShadeCode_Secondary_1,
        ShadeCode_Secondary_2,
    ...
    const getNewGenaratedTheme = (): Theme => ({
        ...
        palette: {
            ...
            mode:
                Theme_LightOrDarkMode === "light" ? "light" : "dark",
            common: {
            ...
            background: {
                ...
                default:
                    Theme_LightOrDarkMode === "light"
                        ? PaletteColors[
                              Theme_PrimaryColor as keyof object
                          ][100]
                        : alpha(
                              PaletteColors[
                                  Theme_PrimaryColor as keyof object
            ...
            action: {
                ...
                hoverOpacity:
                    Theme_LightOrDarkMode === "light" ? 0.03 : 0.03,
                ...
                selectedOpacity:
                    Theme_LightOrDarkMode === "light" ? 0.06 : 0.06,
                ...
                focusOpacity:
                    Theme_LightOrDarkMode === "light" ? 0.09 : 0.09,
                ...
                activatedOpacity:
                    Theme_LightOrDarkMode === "light" ? 0.3 : 0.3,
    ...
    const [Theme_WebApp_Theme, setTheme_WebApp_Theme] =
        useState<Theme>({
            ...currentTheme,
        });
    ...
    useEffect(() => {
        ...
        const Theme_PrimaryColor: any = localStorage.getItem(
            "Theme_PrimaryColor",
        );
        if (Theme_PrimaryColor != null)
            setTheme_PrimaryColor(Theme_PrimaryColor);
        ...
        const Theme_SelectedShadeType_Primary: any =
            localStorage.getItem("Theme_SelectedShadeType_Primary");
        if (Theme_SelectedShadeType_Primary != null)
            setTheme_SelectedShadeType_Primary(
                Theme_SelectedShadeType_Primary,
            );

        const Theme_SelectedShadeType_Secondary: any =
            localStorage.getItem("Theme_SelectedShadeType_Secondary");
    ...
    useEffect(() => {
        ...
        if (Theme_PrimaryColor === "default") {
            ...
            chnageThemeColor({
                light: PaletteColors[Theme_PrimaryColor][
                    ShadeCode_Primary_0
                ],
                main: PaletteColors[Theme_PrimaryColor][
                    ShadeCode_Primary_1
                ],

                dark: PaletteColors[Theme_PrimaryColor][
                    ShadeCode_Primary_2
                ],
    ...
    useEffect(() => {
        ...
        if (Theme_SecondaryColor === "default") {
            chnageThemeColor(
                getNewGenaratedTheme().palette.secondary,
                true,
            );
        } else {
            chnageThemeColor(
                {
                    light: PaletteColors[Theme_SecondaryColor][
                        ShadeCode_Secondary_0
                    ],

                    main: PaletteColors[Theme_SecondaryColor][
                        ShadeCode_Secondary_1
                    ],

                    dark: PaletteColors[Theme_SecondaryColor][
                        ShadeCode_Secondary_2
                    ],
